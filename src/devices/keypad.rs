...
impl Keypad {
    ...
    pub fn read_keypad(&mut self, keys: &mut InputBuffer) {
        ...
        keys.set(0x1, keypad_state.is_scancode_pressed(Scancode::Num1));
        keys.set(0x2, keypad_state.is_scancode_pressed(Scancode::Num2));
        keys.set(0x3, keypad_state.is_scancode_pressed(Scancode::Num3));
        keys.set(0xC, keypad_state.is_scancode_pressed(Scancode::Num4));
        ...
        keys.set(0xD, keypad_state.is_scancode_pressed(Scancode::R));

        keys.set(0x7, keypad_state.is_scancode_pressed(Scancode::A));
        keys.set(0x8, keypad_state.is_scancode_pressed(Scancode::S));
        keys.set(0x9, keypad_state.is_scancode_pressed(Scancode::D));
        keys.set(0xE, keypad_state.is_scancode_pressed(Scancode::F));

        keys.set(0xA, keypad_state.is_scancode_pressed(Scancode::Z));
        keys.set(0x0, keypad_state.is_scancode_pressed(Scancode::X));
        keys.set(0xB, keypad_state.is_scancode_pressed(Scancode::C));
